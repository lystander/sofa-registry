...
public final class SlotManagerImpl implements SlotManager {
  ...
  @Resource private SyncSlotAcceptorManager localSyncSessionAccessorManager;
  ...
  private KeyedTask<SyncSessionTask> commitSyncSessionTask(
    ...
    SlotDiffSyncer syncer =
        new SlotDiffSyncer(
            ...
            sessionLeaseManager,
            localSyncSessionAccessorManager,
            DIFF_LOGGER);
    SyncContinues continues =
        new SyncContinues() {
          @Override
