...
public class MultiClusterMetaServerConfigBean implements MultiClusterMetaServerConfig {
     ...
     *
     * @param remoteSlotSyncerExecutorPoolSize value to be assigned to property remoteSlotSyncerExecutorPoolSize
     */
     ...
     *
     * @param remoteSlotSyncerExecutorQueueSize value to be assigned to property remoteSlotSyncerExecutorQueueSize
     */
     ...
     *
     * @param multiClusterConfigReloadMillis value to be assigned to property multiClusterConfigReloadMillis
     */
     ...
     *
     * @param multiClusterConfigReloadWorkerSize value to be assigned to property multiClusterConfigReloadWorkerSize
     */
     ...
     *
     * @param multiClusterConfigReloadMaxBufferSize value to be assigned to property multiClusterConfigReloadMaxBufferSize
     */
     ...
     *
     * @param remoteClusterHandlerCoreSize value to be assigned to property remoteClusterHandlerCoreSize
     */
     ...
     *
     * @param remoteClusterHandlerMaxBufferSize value to be assigned to property remoteClusterHandlerMaxBufferSize
     */
