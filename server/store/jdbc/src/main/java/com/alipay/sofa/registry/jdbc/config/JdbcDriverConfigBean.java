...
public class JdbcDriverConfigBean implements JdbcDriverConfig {
  ...
  private String url =
      "jdbc:mysql://127.0.0.1:2883/metadatadb?useUnicode=true&characterEncoding=utf8";

  private String username = "obvip_infra_dev_1:infra_public_dev0_2769:metadatadb";

  private String password = "7Yh4Csc4";
